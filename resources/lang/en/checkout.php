...
return [
    ...
    'countdown_banner' => [
        'message' => 'The offer expires in:',
    ],
    'plan_selector' => [
        'heading' => 'Get your ADHD hypnotherapy plan and see results in first month',
        'subheading' => '(without any effort)',
        'title' => 'Select your plan',
        'plan_label' => ':months-month plan',
        'per_month' => 'per month',
