...
<div class="flex items-center bg-white rounded-xl p-4 lg:max-w-[360px] h-[114px] border border-[#ADB1B9] my-4">
    <x-atoms.checkbox :isSelected="$isMostPopular" class="mr-4" />
    ...
    <div class="separator h-full mx-2 border-l border-gray-300" />
</div>
